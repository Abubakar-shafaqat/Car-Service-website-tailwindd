export default function Main() {
  return (
    <div >
    <div className="flex flex-col lg:flex-row items-center justify-center bg-cover bg-center bg-[url('/home.png')] max-h-[18cm] w-full p-6 sm:p-10 md:p-14 lg:p-20 border-gray-300">
      ...
      <div className="mt-16 sm:mt-20 md:mt-32  flex-col items-center lg:items-end p-6 bg-opacity-50 rounded-lg mx-6 lg:mx-16 xl:mx-32 lg:ml-20 lg:mr-20 lg:order-last hidden md:block">
        ...
        <p className="font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-800 leading-snug text-center lg:text-center font-serif">
          <span className="bg-orange-50 px-1 inline-block">First</span> {/* Highlighted */}
          <span className="my-3 text-red-800 inline-block">Class</span> {/* Regular text */}
          <span className="bg-orange-50 px-1 inline-block">Car</span> {/* Highlighted */} <br />
          <span className="text-gray-800 inline-block">Servicing</span> {/* Regular text */}
        </p>

        <p className="mt-6 sm:mt-8 text-orange-50 text-base sm:text-lg md:text-xl lg:text-lg leading-snug mx-6 text-center lg:text-center">
      ...
      {/* Mobile Version */}
      {/* In mobile, we'll adjust the layout */}
      <div className="lg:hidden mt-8 flex flex-col items-center text-center md:hidden ">
        ...
        <p className="mt-4 sm:mt-6 text-orange-50 text-sm sm:text-lg md:text-xl leading-snug">
          YourMechanics – Offering comprehensive car repair and maintenance solutions, delivered conveniently to your doorstep. Whether you’re at home or in the office, we ensure your vehicle is expertly serviced to keep it running smoothly.
        </p>
      ...
      <div className=" mt-20 hidden md:block">
           ...
           <p className="p-2 mr-[11cm] ml-10 mt-5">We provide all types of car repair services to keep your vehicle running smoothly. From regular maintenance like oil changes and tire rotations to bigger repairs for the engine, brakes, or electrical systems, we do it all. Our skilled team is here to make sure your car is safe and reliable.
...
<button className="p-3 bg-yellow-400 border-2 border-black rounded-2xl "><a href="/services">expolre more  →</a></button>
</div>
 
      </div>
      <div className=" mr-10 justify-items-end mt-[-7cm] hidden md:block">
<img src="/do.png" alt="/whhat we do " className="h-[8cm]" />
...
<div className=" mt-20 lg:hidden md:hidden">
           ...
           <p className="p-2  ml-5 mr-5 mt-5">We provide all types of car repair services to keep your vehicle running smoothly. From regular maintenance like oil changes and tire rotations to bigger repairs for the engine, brakes, or electrical systems, we do it all. Our skilled team is here to make sure your car is safe and reliable.
...
<img src="/do.png" alt="/whhat we do " className="h-[6cm] mr-auto ml-auto" />
